...
| BUG-010（引用+Backspace 直後の IME 確定で文字化け） | `@codemirror/view` 6.43.6 / `@codemirror/state` 6.7.1 への更新（`a8326d2`）で 2026-07-22 実機再現せず。**機序は未特定のため、この 2 パッケージのバージョンを安易に戻さないこと**（ダウングレードで再発リスク）。詳細は `issues/tickets/BUG-010.md` |
