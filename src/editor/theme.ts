...
export const nordHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.heading1, color: "var(--heading1)", fontWeight: "700", fontSize: "1.6em" },
  { tag: t.heading2, color: "var(--heading2)", fontWeight: "700", fontSize: "1.4em" },
  { tag: t.heading3, color: "var(--heading3)", fontWeight: "700", fontSize: "1.25em" },
  { tag: t.heading4, color: "var(--heading4)", fontWeight: "700", fontSize: "1.15em" },
  { tag: t.heading5, color: "var(--heading5)", fontWeight: "700", fontSize: "1.05em" },
  { tag: t.heading6, color: "var(--heading6)", fontWeight: "700" },
